...
return [
    ...
    'alpha_numeric_punct'   => 'O campo {field} pode conter apenas caracteres alfanuméricos, espaços e ~ ! # $ % & * - _ + = | : .',
    ...
    'is_not_unique'         => 'O campo {field} deve conter um valor previamente existente na base de dados.',
    ...
    'string'                => 'O campo {field} deve ser uma cadeia de carateres válida.',
